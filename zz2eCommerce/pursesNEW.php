...
?>
                     <div class="image_and_tagline_small">
                        <div data-role="popup" id="popupBasic<?php echo $purse['id']?>" class="photopopup">
                            <img src="images/<?php echo $purse['photo1_url']?>">
                        </div>
                        <div class="image_container_small">
                            <img src="images/<?php echo $purse['photo2_url']?>" width="70" height="105" alt="<?php echo $purse['name']?>" data-transition="slide"><br>
                            <a href="#popupBasic<?php echo $purse['id']?>" data-rel="popup"><img src="images/icon-popup.png" alt="Enlarge image."></a>
                        </div>
